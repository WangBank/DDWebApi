...
namespace DingtalkApprovalApi.Entities.Dtos {
	...
	public partial class DataSelectDefine {
		...
		[JsonProperty, Column(DbType = "varchar(50)")]
		public string HelpCodeField { get; set; } = string.Empty;
		...
		[JsonProperty, Column(DbType = "varchar(50)")]
		public string QUERYFIELD1 { get; set; } = string.Empty;

		[JsonProperty, Column(DbType = "varchar(50)")]
		public string QUERYFIELD2 { get; set; } = string.Empty;

		[JsonProperty, Column(DbType = "varchar(4000)")]
		public string REFRESHSQL { get; set; } = string.Empty;
		...
		public string SourceGridFormat { get; set; } = string.Empty;

		[JsonProperty, Column(DbType = "varchar(8000)")]
		public string TargetGridFormat { get; set; } = string.Empty;

		[JsonProperty, Column(DbType = "varchar(1000)")]
		public string WEBFORMATINFO { get; set; } = string.Empty;
