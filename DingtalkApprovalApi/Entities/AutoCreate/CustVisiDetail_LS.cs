...
namespace DingtalkApprovalApi.Entities.Dtos {
	...
	public partial class CustVisiDetail_LS {
		...
		[JsonProperty, Column(DbType = "varchar(50)")]
		public string RespPers { get; set; } = string.Empty;

		[JsonProperty, Column(DbType = "varchar(500)")]
		public string RESPPERSDESC { get; set; } = string.Empty;

		[JsonProperty, Column(DbType = "varchar(500)")]
		public string VisiContent { get; set; } = string.Empty;

		[JsonProperty, Column(DbType = "varchar(20)")]
		public string VisiEndDate { get; set; } = string.Empty;

		[JsonProperty, Column(DbType = "varchar(500)")]
		public string VisiEval { get; set; } = string.Empty;
