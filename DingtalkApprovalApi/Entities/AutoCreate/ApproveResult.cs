...
namespace DingtalkApprovalApi.Entities.Dtos {
	...
	public partial class ApproveResult {
		...
		[JsonProperty]
		public bool? ApproveEnd { get; set; }

		[JsonProperty, Column(DbType = "varchar(50)")]
		public string ApproveID { get; set; } = string.Empty;

		[JsonProperty, Column(DbType = "varchar(8000)")]
		public string ApproveIdea { get; set; } = string.Empty;

		[JsonProperty, Column(DbType = "varchar(8000)")]
		public string ApproveResult { get; set; } = string.Empty;

		[JsonProperty, Column(DbType = "varchar(50)")]
		public string BillDetailGuid { get; set; } = string.Empty;
