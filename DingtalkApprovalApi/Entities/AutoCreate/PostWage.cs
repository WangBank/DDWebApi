...
namespace DingtalkApprovalApi.Entities.Dtos {
	...
	public partial class PostWage {
		...
		public string PosiCode { get; set; } = string.Empty;

		[JsonProperty, Column(DbType = "varchar(30)")]
		public string PWCode { get; set; } = string.Empty;

		[JsonProperty, Column(DbType = "varchar(10)")]
		public string PWLevel { get; set; } = string.Empty;

		[JsonProperty, Column(DbType = "varchar(30)")]
		public string PWName { get; set; } = string.Empty;

		[JsonProperty, Column(DbType = "varchar(500)")]
		public string PWRequ { get; set; } = string.Empty;
