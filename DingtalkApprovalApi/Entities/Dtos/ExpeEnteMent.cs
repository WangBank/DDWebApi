...
namespace DingtalkApprovalApi.Entities.Dtos {
	...
	public partial class ExpeEnteMent {
		...
		public string CopypersonID { get; set; } = string.Empty;
		...
		[JsonProperty, Column(DbType = "varchar(50)")]
		public string FlowEmployeeGuid { get; set; } = string.Empty;

		[JsonProperty, Column(DbType = "nvarchar(500)")]
		public string HangDDIDs { get; set; } = string.Empty;

		[JsonProperty]
		public int? HangState { get; set; }
