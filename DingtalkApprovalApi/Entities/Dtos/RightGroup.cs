...
namespace DingtalkApprovalApi.Entities.Dtos {
	...
	public partial class RightGroup {
		...
		public string OperatorGroupGuid { get; set; } = string.Empty;
		...
		[JsonProperty, Column(DbType = "varchar(100)")]
		public string RightValue2 { get; set; } = string.Empty;

		[JsonProperty, Column(DbType = "varchar(100)")]
		public string RightValue3 { get; set; } = string.Empty;

		[JsonProperty, Column(DbType = "varchar(100)")]
		public string RightValue4 { get; set; } = string.Empty;

		[JsonProperty, Column(DbType = "varchar(100)")]
		public string RightValue5 { get; set; } = string.Empty;
